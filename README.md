...
| Метрика | Значение |
|---|---|
| Среднее время пустого стола | `52.59 сек (0.88 мин)` |
| Среднее время занятого стола | `38.6 сек (0.64 мин)` |

Такие значение получили из за многочисленных мелких прерываний состояния
